...
class ShopifyInstance(models.Model):
    ...
    def action_view_products(self):
        self.ensure_one()
        return self._action_records(_('Shopify Products'), 'product.product', [('shopify_instance_id', '=', self.id)], 'tree,form')

    def action_view_customers(self):
        self.ensure_one()
        return self._action_records(_('Shopify Customers'), 'res.partner', [('shopify_instance_id', '=', self.id)], 'tree,form')

    def action_view_orders(self):
        self.ensure_one()
        return self._action_records(_('Shopify Orders'), 'sale.order', [('shopify_instance_id', '=', self.id)], 'tree,form')

    def action_view_logs(self):
        self.ensure_one()
        return self._action_records(_('Shopify Sync Logs'), 'shopify.sync.log', [('instance_id', '=', self.id)], 'tree,form')
